Derslerde Selection Sort ve Insertion Sort aynıymış gibi anlatılmış, fakat bu soruyu çözerken aynı olmadıklarını öğrendim. Bu yüzden iki türlü de açıklamaya çalıştım.
